#-*- coding: utf-8 -*-
from flask import current_app as app, Blueprint, render_template, jsonify, send_file, abort, Response, request, session,\
    redirect, url_for
...
def user():
    ...
    return render_template('user.html', user=user, current_user=1)
